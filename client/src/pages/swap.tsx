          ...
          <div className="flex justify-between items-center h-16 w-full max-w-full">
            <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
              ...
              <div className="flex items-center space-x-3 min-w-0 truncate">
                <h1 className="text-lg sm:text-xl lg:text-2xl text-hyper-mint leading-tight whiskerswap-title" style={{ fontWeight: '900', fontFamily: 'ui-sans-serif, system-ui, sans-serif' }}>WhiskerSwap Aggregator</h1>
